...
export default function Exames({navigation, route}) {
    ...
    async function buscarEspecialidade() {
        await fetch('http://192.168.0.105:3000/listarEspecialidades/exames')
            .then(res => res.json())
            .then(res => {
    ...
    async function buscarProfissionais() {
        ...
        await fetch('http://192.168.0.105:3000/listarProfissionaisEspecialidade/' + especialidade)
            .then(res => res.json())
            .then(res => {
    ...
    async function buscarHorario() {
        let response = await fetch('http://192.168.0.105:3000/buscarHorario/vacinas', {
            method: 'POST',
            headers: {
    ...
    async function Agendar() {
        ...
        let response = await fetch('http://192.168.0.105:3000/agendar/consulta', {
            method: 'POST',
            headers: {
                Accept: 'application/json',
                'Content-Type': 'application/json'
