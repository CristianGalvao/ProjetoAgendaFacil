            ...
            <View style={styles.cartContainer}>
                <ScrollView>
                            ...
                            renderItem={({ item }) => (
                                ...
                                <View style={styles.productView}>
                                    ...
                                    <View style={styles.productMiddleView}>
                                        ...
                                        <Text style={styles.productTitle}>Codigo Consulta:{setId(item.id)} {item.id}</Text>
                                        <Text style={styles.productTitle}>{item.especialidade}</Text>
                                        <Text style={styles.productTitle}>{item.dia}</Text>

                                    </View>

                                    <View style={styles.productRightView}>
                                        <Text style={styles.productTitle}>{item.preco}</Text>
                                        <Text onPress={() => removerAgendamentoPendente()} style={{ color: 'red', marginTop: 10, fontSize: 16 }}>Remover</Text>
                                    </View>
                    ...
                    <View style={styles.subtotalView}>
                        ...
                        {
                            dadosPendentesPreco.map((buscar) =>
                                <Text style={styles.subtotalPrice}>{buscar.total}</Text>
                            )
                        }
